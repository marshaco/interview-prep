...
import { modules, getQuestion } from '../../content/registry';
...
export function DashboardPage() {
  ...
  const dueToday = buildTodaysReview(data.reviewRecords, masteryBySkill, today, Number.MAX_SAFE_INTEGER);
  ...
  return (
    <div>
      ...
      <h1 className="mb-8 text-xl font-semibold text-text">Dashboard</h1>

      <div className="mb-8 grid grid-cols-3 gap-3">
        <div className="rounded border border-border bg-bg-raised p-4">
          <p className="text-2xl font-semibold text-text">{current}</p>
